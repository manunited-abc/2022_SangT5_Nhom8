...
public class Constant {
    ...
    public static String GOOGLE_CLIENT_SECRET = "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";
    public static String GOOGLE_REDIRECT_URI = "http://localhost:8080/signWithGoogle";
